...
while (my $line = <>) {
  ...
  } elsif ($plugin eq "HighWireDrupalPlugin" || $plugin eq "OUPDrupalPlugin" || $plugin eq "APSDrupalPlugin") {
  ...
  } elsif ($plugin eq "ClockssHighWireDrupalPlugin" || $plugin eq "ClockssOUPDrupalPlugin" || $plugin eq "ClockssAPSDrupalPlugin") {
