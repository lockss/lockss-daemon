...
#Ready
echo "###Ready Atypon 2018" > $t/tmp_Atypon  #clear out file
./scripts/tdb/tdbout -Y -a -Q 'plugin ~ "typon" and year is "2018" and (au:hidden[proxy] is not set or au:hidden[proxy] is "")' tdb/clockssingest/*.tdb | shuf >> $t/tmp_Atypon
echo "###Ready Atypon not 2018" >> $t/tmp_Atypon
./scripts/tdb/tdbout -Y -a -Q 'plugin ~ "typon" and year is not "2018" and (au:hidden[proxy] is not set or au:hidden[proxy] is "")' tdb/clockssingest/*.tdb | shuf >> $t/tmp_Atypon
#Manifest
