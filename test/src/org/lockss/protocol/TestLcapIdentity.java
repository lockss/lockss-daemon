...
public class TestLcapIdentity extends TestCase {
  ...
  public void testGetIdentity() {
    LcapIdentity id1 = LcapIdentity.getIdentity(testAddress);
    assertTrue(id1 != null);
  ...
  public void testCallInternalPoll() {
    ...
    checkReputation(rep, LcapIdentity.CALL_INTERNAL_DELTA, 
  ...
  public void testVoteNotVerify() {
    ...
    checkReputation(rep, LcapIdentity.VOTE_NOT_VERIFIED, 
		    fakeId.getReputation());
  }
  ...
  public void testChangeReputation() {
    ...
    assertTrue(fakeId.getReputation() <= 
	       rep +LcapIdentity.MAX_REPUTATION_DELTA);
    rep = fakeId.getReputation();
    fakeId.changeReputation(-LcapIdentity.MAX_REPUTATION_DELTA * 10);
    assertTrue(fakeId.getReputation() >= 
	       rep - LcapIdentity.MAX_REPUTATION_DELTA);
