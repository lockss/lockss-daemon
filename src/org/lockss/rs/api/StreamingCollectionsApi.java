...
public class StreamingCollectionsApi extends CollectionsApi {
  ...
  public StreamingCollectionsApi(ApiClient apiClient) {
    super(apiClient);
   ...
   */
  public com.squareup.okhttp.Call createArtifactCall(String auid, String uri, Long collectionDate, InputStream artifact, String collectionid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
  ...
  private com.squareup.okhttp.Call createArtifactValidateBeforeCall(String auid, String uri, Long collectionDate, InputStream artifact, String collectionid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
   ...
   */
  public Artifact createArtifact(String auid, String uri, Long collectionDate, InputStream artifact, String collectionid) throws ApiException {
   ...
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
   */
  public ApiResponse<Artifact> createArtifactWithHttpInfo(String auid, String uri, Long collectionDate, InputStream artifact, String collectionid) throws ApiException {
   ...
   */
  public com.squareup.okhttp.Call createArtifactAsync(String auid, String uri, Long collectionDate, InputStream artifact, String collectionid, final ApiCallback<Artifact> callback) throws ApiException {
