...
public class RootPageProducer {
  public final static String CATALOG_AU_ID ="CatalogAU"; // The Id of the Catalog AU? 
  public final static String AU_FQDN_MASK = "http://lockssbox/catalogAU/%s"; // This will be finalized once the protocol is decided
  public final static String AU_LINK_TEXT_MASK = "AU %s"; //The text (caption) for the root page link to each AU 
  public final static String AU_CATALOG_PAGE_CONTENT_TYPE = "text/html"; //"application/xhtml+xml" maybe?
  public final static String CATALOG_AU_ROOT_PAGE ="index.html"; // name of the root page
  public final static String CATALOG_ROOT_PAGE_TITLE = "LOCKSS Catalog Root Page"; // Title of the root page
  /*
   * Given the root daemon object, enumerate all AUs it handles
   * and generate the root page of the CatalogAU while also updating its contents 
   * with URLs pointing to each cataloged AU 
   */
  public static void produce(LockssDaemon daemon, ArchivalUnit catalogAU, LockssWatchdog wdog) throws Exception {
    //begin generating the root page, complete it on the fly as we enumerate AUs
    ...
    of.setDoctype("-//W3C//DTD XHTML 1.0 Strict//EN", "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd");
    ...
    hd.characters(CATALOG_ROOT_PAGE_TITLE.toCharArray(), 0, CATALOG_ROOT_PAGE_TITLE.length());
    hd.endElement("","","title");
    attrs.clear();
    ...
    headers.setProperty(CachedUrl.PROPERTY_CONTENT_TYPE, AU_CATALOG_PAGE_CONTENT_TYPE); 
