...
public class UrlToChecksumMap {
  ...
  /*
   * A copy constructor performing a deep copy of the class and its accompanying map 
   */
  ...
  /*
   * Overridden because equals was also overridden, to provide a meaningful hash code 
   */
  @Override
  public int hashCode() {
    return map.hashCode();
