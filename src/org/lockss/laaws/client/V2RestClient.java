...
public class V2RestClient {
   ...
   */
  public V2RestClient(OkHttpClient client) {
    init();
   ...
   */
  public V2RestClient setHttpClient(OkHttpClient newHttpClient) {
   ...
   * @return a {@link org.lockss.laaws.client.V2RestClient} object
   */
   ...
   * @return V2RestClient
   */
  public V2RestClient addDefaultCookie(String key, String value) {
  ...
  public Call buildCall(String baseUrl, String path, String method, List<Pair> queryParams,
    ...
    Request request = buildRequest(baseUrl, path, method, queryParams, collectionQueryParams, body,
