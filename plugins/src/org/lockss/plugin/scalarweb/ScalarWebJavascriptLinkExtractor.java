...
public class ScalarWebJavascriptLinkExtractor implements LinkExtractor {

    private static final Logger log = Logger.getLogger(ScalarWebJavascriptLinkExtractor.class);
    ...
    public ScalarWebJavascriptLinkExtractor() {
    }

    public ScalarWebJavascriptLinkExtractor(int maxBuf, int overlap) {
        this.maxBuf = maxBuf;
