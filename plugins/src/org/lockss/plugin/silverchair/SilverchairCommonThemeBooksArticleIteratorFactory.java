...
public class SilverchairCommonThemeBooksArticleIteratorFactory implements ArticleIteratorFactory,
    ...
    private static Pattern PDF_LANDING_PAGE_PATTERN = Pattern.compile("/([^/]+)/books/book/([^\\.]+)$", Pattern.CASE_INSENSITIVE);

    private static String PDF_LANDING_PAGE_REPLACEMENT = "/$1/books/book/$2";
