...
public class UnivofAnbarCollegeofAgCrawlSeed extends BaseCrawlSeed {

    private static final Logger log = Logger.getLogger(UnivofAnbarCollegeofAgCrawlSeed.class);

    //https://ajas.uoanbar.edu.iq/browse?_action=issue
    ...
    public UnivofAnbarCollegeofAgCrawlSeed(Crawler.CrawlerFacade facade) {
        super(facade);
        if (au == null) {
    ...
    protected void populateUrlList() throws IOException {
        ...
        LinkExtractor ple = new UnivofAnbarCollegeofAgVolumeIssueLinkExtractor(defaultExtractor);

        UrlFetcher uf = makeApiUrlFetcher((UnivofAnbarCollegeofAgVolumeIssueLinkExtractor) ple, apiStartUrl, this.browseIssueUrl);
     ...
     * @since 1.67.5
     */
    protected UrlFetcher makeApiUrlFetcher( final UnivofAnbarCollegeofAgVolumeIssueLinkExtractor ple,
                                            final String url,
