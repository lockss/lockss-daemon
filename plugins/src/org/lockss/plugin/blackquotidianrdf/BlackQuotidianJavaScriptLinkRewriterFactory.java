...
public class BlackQuotidianJavaScriptLinkRewriterFactory implements LinkRewriterFactory {

    static final Logger logger =
            Logger.getLogger(BlackQuotidianJavaScriptLinkRewriterFactory.class);
