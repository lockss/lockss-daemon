...
public class BlackQuotidianJavascriptLinkExtractor implements LinkExtractor {

    private static final Logger log = Logger.getLogger(BlackQuotidianJavascriptLinkExtractor.class);
    ...
    private static final String BASE_URI = "http://blackquotidian.supdigital.org/system/application/views/arbors/html5_RDFa";
    private static final String WIDGET_URI = "http://blackquotidian.supdigital.org/system/application/views/widgets";
    ...
    public BlackQuotidianJavascriptLinkExtractor() {
    }

    public BlackQuotidianJavascriptLinkExtractor(int maxBuf, int overlap) {
        this.maxBuf = maxBuf;
