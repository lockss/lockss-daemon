...
public class OxfordUniversityPressSourceXmlMetadataExtractorFactory extends SourceXmlMetadataExtractorFactory {
    static Logger log = Logger.getLogger(OxfordUniversityPressSourceXmlMetadataExtractorFactory.class);
