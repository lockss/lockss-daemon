...
public class ScientificVideoProtocolsRisArticleIteratorFactory implements ArticleIteratorFactory, ArticleMetadataExtractorFactory {

    protected static Logger log = Logger.getLogger(ScientificVideoProtocolsRisArticleIteratorFactory.class);
