...
public class VSERCSourcePluginArticleIteratorFactory implements ArticleIteratorFactory, ArticleMetadataExtractorFactory {

    protected static Logger log = Logger.getLogger(VSERCSourcePluginArticleIteratorFactory.class);
