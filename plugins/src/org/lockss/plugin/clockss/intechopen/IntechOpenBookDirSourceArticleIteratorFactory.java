...
public class IntechOpenBookDirSourceArticleIteratorFactory implements ArticleIteratorFactory, ArticleMetadataExtractorFactory {

    protected static Logger log = Logger.getLogger(IntechOpenBookDirSourceArticleIteratorFactory.class);
