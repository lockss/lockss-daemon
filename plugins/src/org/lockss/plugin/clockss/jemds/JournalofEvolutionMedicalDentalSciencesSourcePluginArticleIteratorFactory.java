...
public class JournalofEvolutionMedicalDentalSciencesSourcePluginArticleIteratorFactory implements ArticleIteratorFactory, ArticleMetadataExtractorFactory {

    protected static Logger log = Logger.getLogger(JournalofEvolutionMedicalDentalSciencesSourcePluginArticleIteratorFactory.class);
