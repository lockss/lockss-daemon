...
public class BitsPublishingSchemaHelper implements SourceXmlSchemaHelper {
    private static final Logger log = Logger.getLogger(BitsPublishingSchemaHelper.class);
