...
public class BioscientificaPdfFilterFactory extends ExtractingPdfFilterFactory {

  private static final Logger log = Logger.getLogger(BioscientificaPdfFilterFactory.class);
  /*
   *
   */

  protected static final Pattern WATERMARK_LINE_1 =
      Pattern.compile("^Downloaded from Bioscientifica");
  protected static final Pattern WATERMARK_LINE_2_VARIANTS =
      Pattern.compile("via (stanford univ(ersity) medical center and )(c?lockss archive|communal account|c?lockks archive)", Pattern.CASE_INSENSITIVE);
  ...
  public static void main(String[] args) throws Exception {
    ...
    for (String fileStr : fileStrs) {
      FilterFactory fact = new BioscientificaPdfFilterFactory();
