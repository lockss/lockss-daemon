...
public class TestHBKUHtmlFilterFactory extends LockssTestCase {
  static String ENC = Constants.DEFAULT_ENCODING;

  private HBKUHtmlFilterFactory fact;
  private MockArchivalUnit mau;

  public void setUp() throws Exception {
    super.setUp();
    fact = new HBKUHtmlFilterFactory();
...
"href=\"http://www.qscience.org/content/journal/ecosalplus/10.1128/ecosalplus.3.2.4\">" +
"http://www.qscience.org/content/journal/ecosalplus/10.1128/ecosalplus.3.2.4</a>). " +
